...
import com.ucloudlink.configuration.sap.CustomDestinationDataProvider.MyDestinationDataProvider;
...
public class StepByStepClient
{
    ...
    public static void maint(String[] args) throws JCoException
    {
        //step1Connect();
    ...
    /* static  {
        ...
        myProvider.changeProperties(ABAP_AS, getDestinationPropertiesFromUI());
        myProvider.changeProperties(ABAP_AS_POOLED, getDestinationPropertiesFromUI());
        myProvider.changeProperties(ABAP_MS, getDestinationPropertiesFromUI());
    }*/
    
    static Properties getDestinationPropertiesFromUI()
    {
        Properties connectProperties = new Properties();
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "10.1.76.63");
        connectProperties.setProperty(DestinationDataProvider.JCO_SYSNR,  "00");
        connectProperties.setProperty(DestinationDataProvider.JCO_CLIENT, "300");
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "RFCUSER");
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "654321");
        connectProperties.setProperty(DestinationDataProvider.JCO_LANG,   "ZH");
        //connectProperties.setProperty(DestinationDataProvider.JCO_SAPROUTER,   "192.168.30.185");
