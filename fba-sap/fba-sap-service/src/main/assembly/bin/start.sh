...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -Xbootclasspath/a:$CONF_DIR -jar -Dspring.config.location=conf/application.properties  lib/fba-sap-service-0.0.1-SNAPSHOT.jar > /dev/null 2>&1 &
